...
LEVR.bet	https://cdn.prod.website-files.com/669ade140a683001b9f7fd78/67b91601c0e02b5b7bf0bccc_LEVR.bet_logo.webp	App	DeFi	https://x.com/levr_bet	http://levr.bet/	https://cdn.prod.website-files.com/669ade140a683001b9f7fd78/67b916025d51b1bcd91c3c36_LFJ_banner.webp	Leverage Sports Betting with Fully Liquid Positions.	Yes	
LFJ	https://cdn.prod.website-files.com/669ade140a683001b9f7fd78/67b91601c0e02b5b7bf0bccc_LEVR.bet_logo.webp	App	DeFi	https://x.com/LFJ_gg	https://pandaria.lfj.gg/	https://cdn.prod.website-files.com/669ade140a683001b9f7fd78/67b916025d51b1bcd91c3c36_LFJ_banner.webp	The onchain trading platform built for winners. One-stop DEX, Aggregator &amp; Screener for Monad. Discover &amp; buy every token at the best prices.	No	
...
MERV	https://cdn.prod.website-files.com/669ade140a683001b9f7fd78/67b9164ba00e125f94a0513b_MERV_logo.webp	App	AI	https://x.com/merv_wtf	https://merv.wtf/	https://cdn.prod.website-files.com/669ade140a683001b9f7fd78/67b9164611a6f58966793393_MERV_banner.webp	IP creation platform powered by AI.	No
...
export default function ProjectsPage() {
  ...
  const projectData = parseTSVData(rawTSVData)

  console.log("[v0] Total projects loaded:", projectData.length)
  ...
  const filteredProjects = useMemo(() => {
    ...
    if (activeTag) {
      filtered = filtered.filter((project) => project.tags.some((tag) => tag === activeTag))
    }
    ...
    return filtered
  }, [activeTag, projectData, searchQuery])
    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-zinc-900 to-black text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8 space-y-6">
          <div className="flex items-center justify-between">
            <Button
              variant="ghost"
              onClick={() => router.push("/")}
              className="text-white hover:text-purple-400 hover:bg-purple-500/10 transition-all duration-300"
            >
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-zinc-900/80 border border-zinc-800 rounded-2xl text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300"
            />
          </div>
        </div>
        ...
        {!showCategories ? (
          <button
            ...
            className="w-full mb-8 px-6 py-3 bg-gradient-to-r from-purple-600/80 to-purple-700/80 hover:from-purple-500/80 hover:to-purple-600/80 backdrop-blur-xl text-white text-base font-bold rounded-2xl transition-all duration-300 hover:scale-[1.02] shadow-2xl shadow-purple-500/20 border border-purple-500/30"
          >
            Show Categories ({allTags.length})
          </button>
        ) : (
          <div className="mb-8 backdrop-blur-xl rounded-3xl border border-purple-500/30 shadow-2xl shadow-purple-500/10 p-6 animate-in slide-in-from-top duration-300">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold bg-gradient-to-r from-white to-purple-300 bg-clip-text text-transparent">
                Filter by Category
              </h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
          {filteredProjects.map((project, index) => (
            <div
              ...
              className="group cursor-pointer bg-gradient-to-br from-zinc-900 to-zinc-800 hover:from-zinc-800 hover:to-zinc-700 border border-zinc-800 hover:border-purple-500 rounded-2xl p-4 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/20"
            >
              <div className="aspect-square mb-3 rounded-xl overflow-hidden bg-zinc-800 flex items-center justify-center group-hover:ring-2 group-hover:ring-purple-500/50 transition-all duration-300">
                <img
              ...
              <h3 className="text-sm font-bold text-center truncate group-hover:text-purple-400 transition-colors">
                {project.name}
              </h3>
              <p className="text-xs text-zinc-400 text-center mt-1">{project.category}</p>
            </div>
          ))}
        </div>
          ...
          <div className="text-center py-16">
            ...
            <button
              onClick={() => {
                setSearchQuery("")
                setActiveTag(null)
                setShowCategories(false) // Ensure categories are hidden when clearing filters
              }}
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-3xl bg-zinc-900 rounded-2xl border border-zinc-800 overflow-hidden">
            <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <a
                  ...
                  className="flex-1 px-4 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors text-center"
                >
                  Visit Website
                </a>
                <a
