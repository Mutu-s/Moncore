      ...
      <div className="absolute inset-0 z-20 flex flex-col p-4 pointer-events-none">
        <div className="flex justify-between items-center mb-4 pointer-events-auto">
          <div className="flex items-center">
            <Button
              variant="outline"
              className="border-teal-500 text-teal-500 hover:bg-teal-900/20 mr-2 bg-transparent"
            >
              <Plus className="mr-2 h-4 w-4" />
            </Button>
            <Button variant="outline" className="border-teal-500 text-teal-500 hover:bg-teal-900/20 bg-transparent">
          ...
          <TabsContent value="builder" className="flex-1 flex mt-4">
            <div className="w-64 bg-black/80 border-teal-500/30 backdrop-blur-md rounded-lg p-4 mr-4 pointer-events-auto">
              ...
              <div className="space-y-3">
                <BlockCategory title="" icon={<BarChart2 className="h-4 w-4 text-teal-500" />}>
                  <DraggableBlock title="" color="#0d9488" />
                  <DraggableBlock title="" color="#0d9488" />
                  <DraggableBlock title="" color="#0d9488" />
                  <DraggableBlock title="" color="#0d9488" />
                </BlockCategory>

                <BlockCategory title="" icon={<Filter className="h-4 w-4 text-teal-500" />}>
                  <DraggableBlock title="" color="#0891b2" />
                  <DraggableBlock title="" color="#0891b2" />
                  <DraggableBlock title="" color="#0891b2" />
                  <DraggableBlock title="" color="#0891b2" />
                </BlockCategory>

                <BlockCategory title="" icon={<Sliders className="h-4 w-4 text-teal-500" />}>
                  <DraggableBlock title="" color="#7c3aed" />
                  <DraggableBlock title="" color="#7c3aed" />
                  <DraggableBlock title="" color="#7c3aed" />
                  <DraggableBlock title="" color="#7c3aed" />
                </BlockCategory>

                <BlockCategory title="" icon={<Cpu className="h-4 w-4 text-teal-500" />}>
                  <DraggableBlock title="" color="#db2777" />
                  <DraggableBlock title="" color="#db2777" />
                  <DraggableBlock title="" color="#db2777" />
                </BlockCategory>
              </div>
            ...
            <div className="flex-1 bg-black/80 border-teal-500/30 backdrop-blur-md rounded-lg p-4 pointer-events-auto">
              <div className="flex justify-between items-center mb-4">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="border-teal-500 text-teal-500 hover:bg-teal-900/20 bg-transparent"
                >
              ...
              <div className="h-[calc(100%-40px)] bg-gray-900/50 rounded-lg border border-gray-800 flex items-center justify-center">
                <div className="text-gray-400 text-center">
                  ...
                  <Button
                    variant="outline"
                    className="mt-2 border-teal-500 text-teal-500 hover:bg-teal-900/20 bg-transparent"
                  >
                    <Plus className="mr-2 h-4 w-4" />
                  </Button>
                </div>
            ...
            <div className="bg-black/80 border-teal-500/30 backdrop-blur-md rounded-lg p-4 h-full pointer-events-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <label className="text-sm font-medium text-gray-300 block mb-2"></label>
                    <input
                      type="text"
              ...
              <div className="mt-6">
                <Button className="bg-teal-500 hover:bg-teal-600 text-black font-bold"></Button>
              </div>
            </div>
          </TabsContent>
        </Tabs>
