                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  ...
                  <TabsContent value="performance" className="mt-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                      <MetricCard title="" value="" positive={true} />
                      <MetricCard title="" value="" positive={true} />
                      <MetricCard title="" value="" positive={false} />
                      <MetricCard title="" value="" positive={true} />
                    </div>
                  ...
                  <TabsContent value="trades" className="mt-4">
                    <div className="bg-gray-900/50 rounded-lg p-4 mb-4">
                      <div className="space-y-3">
                        <TradeRow date="" symbol="" type="" price="" result="" positive={true} />
                        <TradeRow date="" symbol="" type="" price="" result="" positive={true} />
                        <TradeRow date="" symbol="" type="" price="" result="" positive={false} />
                        <TradeRow date="" symbol="" type="" price="" result="" positive={true} />
                      </div>
                    </div>
                    <Button
  ...
  return (
    <group ref={chartRef} position={[0, -1, 0]}>
      ...
      <Html position={[-8, -0.5, 0]} transform>
        <div className="bg-black/70 text-white text-xs px-2 py-1 rounded whitespace-nowrap"></div>
      </Html>
      <Html position={[8, -0.5, 0]} transform>
        <div className="bg-black/70 text-white text-xs px-2 py-1 rounded whitespace-nowrap"></div>
      </Html>
