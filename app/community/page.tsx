            ...
            <Card className="bg-black/80 border-teal-500/30 backdrop-blur-md pointer-events-auto md:col-span-2">
              ...
              <CardContent>
                <div className="space-y-4">
                  <StrategyCard title="" author="" rating={4.8} downloads={1240} tags={[]} />
                  <StrategyCard title="" author="" rating={4.6} downloads={980} tags={[]} />
                  <StrategyCard title="" author="" rating={4.5} downloads={750} tags={[]} />
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black/80 border-teal-500/30 backdrop-blur-md pointer-events-auto">
              ...
              <CardContent>
                <div className="space-y-3">
                  <LeaderboardRow rank={1} name="" avatar="" performance="" />
                  <LeaderboardRow rank={2} name="" avatar="" performance="" />
                  <LeaderboardRow rank={3} name="" avatar="" performance="" />
                  <LeaderboardRow rank={4} name="" avatar="" performance="" />
                  <LeaderboardRow rank={5} name="" avatar="" performance="" />
                </div>
              </CardContent>
            </Card>
          </div>
